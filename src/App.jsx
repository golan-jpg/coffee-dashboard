...
const cityAreaDefinitions = {
  ...
  paris: [
    { canonical: "Le Marais", aliases: ["le marais", "marais"] },
    { canonical: "Saint-Germain-des-Prés", aliases: ["saint-germain-des-pres", "saint germain des pres", "st germain", "saint-germain"] },
    { canonical: "Latin Quarter", aliases: ["latin quarter", "quartier latin"] },
    { canonical: "Montmartre", aliases: ["montmartre"] },
    { canonical: "Canal Saint-Martin", aliases: ["canal saint-martin", "canal saint martin"] },
    { canonical: "Bastille", aliases: ["bastille"] },
    { canonical: "Belleville", aliases: ["belleville"] },
    { canonical: "Oberkampf", aliases: ["oberkampf"] },
    { canonical: "Pigalle", aliases: ["pigalle"] },
    { canonical: "Batignolles", aliases: ["batignolles"] },
    { canonical: "République", aliases: ["republique", "république"] },
  ],
  berlin: [
  ...
  "tel aviv": [
    ...
    { canonical: "Neve Tzedek", aliases: ["neve tzedek", "נווה צדק"] },
    { canonical: "Rothschild", aliases: ["rothschild", "רוטשילד"] },
    { canonical: "Dizengoff", aliases: ["dizengoff", "דיזנגוף"] },
    { canonical: "Lev Ha'Ir", aliases: ["lev hair", "lev ha'ir", "לב העיר"] },
    { canonical: "Kerem HaTeimanim", aliases: ["kerem hateimanim", "kerem ha teimanim", "כרם התימנים"] },
    { canonical: "Jaffa", aliases: ["jaffa", "yafo", "יפו"] },
    { canonical: "Old North", aliases: ["old north", "הצפון הישן"] },
  ],
  rome: [
    { canonical: "Trastevere", aliases: ["trastevere"] },
    { canonical: "Monti", aliases: ["monti"] },
    { canonical: "Testaccio", aliases: ["testaccio"] },
    { canonical: "Prati", aliases: ["prati"] },
