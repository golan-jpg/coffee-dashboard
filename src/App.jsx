...
const cityAreaDefinitions = {
  ...
  "new york": [
    { canonical: "Manhattan", aliases: ["manhattan"] },
    { canonical: "SoHo", aliases: ["soho", "so-ho"] },
    { canonical: "NoHo", aliases: ["noho", "no ho"] },
    { canonical: "Nolita", aliases: ["nolita"] },
    { canonical: "Lower East Side", aliases: ["lower east side", "les"] },
    { canonical: "East Village", aliases: ["east village"] },
    { canonical: "West Village", aliases: ["west village"] },
    { canonical: "Greenwich Village", aliases: ["greenwich village"] },
    { canonical: "Chelsea", aliases: ["chelsea"] },
    { canonical: "Flatiron", aliases: ["flatiron", "flat iron"] },
    { canonical: "Midtown", aliases: ["midtown"] },
    { canonical: "Upper West Side", aliases: ["upper west side", "uws"] },
    { canonical: "Upper East Side", aliases: ["upper east side", "ues"] },
    { canonical: "Williamsburg", aliases: ["williamsburg"] },
    { canonical: "DUMBO", aliases: ["dumbo"] },
    { canonical: "Brooklyn Heights", aliases: ["brooklyn heights"] },
  ],
  paris: [
    { canonical: "Le Marais", aliases: ["le marais", "marais", "haut marais", "3rd arrondissement", "4th arrondissement"] },
    { canonical: "Saint-Germain-des-Prés", aliases: ["saint-germain-des-pres", "saint germain des pres", "st germain", "saint-germain", "6th arrondissement"] },
    { canonical: "Latin Quarter", aliases: ["latin quarter", "quartier latin", "5th arrondissement"] },
    { canonical: "Montmartre", aliases: ["montmartre"] },
    { canonical: "Canal Saint-Martin", aliases: ["canal saint-martin", "canal saint martin", "10th arrondissement"] },
    { canonical: "Bastille", aliases: ["bastille", "11th arrondissement"] },
    { canonical: "Belleville", aliases: ["belleville"] },
    { canonical: "Oberkampf", aliases: ["oberkampf"] },
    { canonical: "Pigalle", aliases: ["pigalle", "9th arrondissement"] },
    { canonical: "Batignolles", aliases: ["batignolles"] },
    { canonical: "République", aliases: ["republique", "république", "place de la republique", "place de la république"] },
    { canonical: "Montparnasse", aliases: ["montparnasse", "14th arrondissement"] },
    { canonical: "Sentier", aliases: ["sentier", "2nd arrondissement"] },
  ],
  berlin: [
    { canonical: "Mitte", aliases: ["mitte"] },
    { canonical: "Kreuzberg", aliases: ["kreuzberg"] },
    { canonical: "Neukölln", aliases: ["neukolln", "neukölln"] },
    { canonical: "Friedrichshain", aliases: ["friedrichshain"] },
    { canonical: "Prenzlauer Berg", aliases: ["prenzlauer berg"] },
    { canonical: "Charlottenburg", aliases: ["charlottenburg"] },
    { canonical: "Schöneberg", aliases: ["schoneberg", "schöneberg"] },
    { canonical: "Wedding", aliases: ["wedding"] },
    { canonical: "Moabit", aliases: ["moabit"] },
  ],
  amsterdam: [
    { canonical: "Jordaan", aliases: ["jordaan"] },
    { canonical: "De Pijp", aliases: ["de pijp"] },
    { canonical: "Oud-West", aliases: ["oud-west", "oud west"] },
    { canonical: "Oud-Zuid", aliases: ["oud-zuid", "oud zuid"] },
    { canonical: "Centrum", aliases: ["centrum", "city center", "city centre"] },
    { canonical: "Noord", aliases: ["noord", "amsterdam noord"] },
  ],
  barcelona: [
    { canonical: "El Born", aliases: ["el born", "born"] },
    { canonical: "Gothic Quarter", aliases: ["gothic quarter", "barri gotic", "barri gòtic", "gothic"] },
    { canonical: "Eixample", aliases: ["eixample"] },
    { canonical: "Gràcia", aliases: ["gracia", "gràcia"] },
    { canonical: "Poblenou", aliases: ["poblenou"] },
    { canonical: "Sant Antoni", aliases: ["sant antoni"] },
    { canonical: "Raval", aliases: ["raval", "el raval"] },
  ],
  "tel aviv": [
    { canonical: "Florentin", aliases: ["florentin", "פלורנטין"] },
    { canonical: "Neve Tzedek", aliases: ["neve tzedek", "נווה צדק", "נווה-צדק"] },
    { canonical: "Rothschild", aliases: ["rothschild", "rothschild blvd", "rothschild boulevard", "שדרות רוטשילד", "רוטשילד"] },
    { canonical: "Dizengoff", aliases: ["dizengoff", "dizengoff st", "דיזנגוף"] },
    { canonical: "Lev Ha'Ir", aliases: ["lev hair", "lev ha'ir", "lev hair", "לב העיר"] },
    { canonical: "Kerem HaTeimanim", aliases: ["kerem hateimanim", "kerem ha teimanim", "כרם התימנים"] },
    { canonical: "Jaffa", aliases: ["jaffa", "yafo", "old jaffa", "יפו", "יפו העתיקה"] },
    { canonical: "Old North", aliases: ["old north", "north old", "הצפון הישן"] },
    { canonical: "Sarona", aliases: ["sarona", "שרונה"] },
    { canonical: "Nahalat Binyamin", aliases: ["nahalat binyamin", "nahalat benyamin", "נחלת בנימין"] },
    { canonical: "Carmel Market", aliases: ["carmel market", "shuk hacarmel", "shuk ha carmel", "שוק הכרמל"] },
  ],
  rome: [
    { canonical: "Trastevere", aliases: ["trastevere", "rione xiii"] },
    { canonical: "Monti", aliases: ["monti", "rione i"] },
    { canonical: "Testaccio", aliases: ["testaccio"] },
    { canonical: "Prati", aliases: ["prati", "prati-della-vittoria"] },
    { canonical: "San Lorenzo", aliases: ["san lorenzo"] },
    { canonical: "Pigneto", aliases: ["pigneto"] },
    { canonical: "Centro Storico", aliases: ["centro storico", "historic center", "historic centre"] },
    { canonical: "Campo de' Fiori", aliases: ["campo de fiori", "campo de' fiori"] },
    { canonical: "Ostiense", aliases: ["ostiense"] },
  ],
  madrid: [
    { canonical: "Malasaña", aliases: ["malasana", "malasaña"] },
    { canonical: "Chueca", aliases: ["chueca"] },
    { canonical: "La Latina", aliases: ["la latina"] },
    { canonical: "Lavapiés", aliases: ["lavapies", "lavapiés"] },
    { canonical: "Salamanca", aliases: ["salamanca"] },
    { canonical: "Chamberí", aliases: ["chamberi", "chamberí"] },
  ],
  lisbon: [
    { canonical: "Bairro Alto", aliases: ["bairro alto"] },
    { canonical: "Chiado", aliases: ["chiado"] },
    { canonical: "Baixa", aliases: ["baixa"] },
    { canonical: "Alfama", aliases: ["alfama"] },
    { canonical: "Príncipe Real", aliases: ["principe real", "príncipe real"] },
    { canonical: "Santos", aliases: ["santos"] },
    { canonical: "Cais do Sodré", aliases: ["cais do sodre", "cais do sodré"] },
    { canonical: "Graça", aliases: ["graca", "graça"] },
    { canonical: "Belém", aliases: ["belem", "belém"] },
  ],
  porto: [
    { canonical: "Ribeira", aliases: ["ribeira"] },
    { canonical: "Baixa", aliases: ["baixa", "baixa do porto"] },
    { canonical: "Cedofeita", aliases: ["cedofeita"] },
    { canonical: "Foz do Douro", aliases: ["foz do douro", "foz"] },
    { canonical: "Bonfim", aliases: ["bonfim"] },
    { canonical: "Boavista", aliases: ["boavista"] },
    { canonical: "Campanhã", aliases: ["campanha", "campanhã"] },
  ],
  prague: [
    { canonical: "Old Town", aliases: ["old town", "stare mesto", "staré město"] },
    { canonical: "New Town", aliases: ["new town", "nove mesto", "nové město"] },
    { canonical: "Vinohrady", aliases: ["vinohrady"] },
    { canonical: "Žižkov", aliases: ["zizkov", "žižkov"] },
    { canonical: "Karlín", aliases: ["karlin", "karlín"] },
    { canonical: "Holešovice", aliases: ["holesovice", "holešovice"] },
    { canonical: "Smíchov", aliases: ["smichov", "smíchov"] },
    { canonical: "Malá Strana", aliases: ["mala strana", "malá strana"] },
  ],
  vienna: [
    { canonical: "Innere Stadt", aliases: ["innere stadt", "1st district", "district 1"] },
    { canonical: "Leopoldstadt", aliases: ["leopoldstadt"] },
    { canonical: "Neubau", aliases: ["neubau", "7th district", "district 7"] },
    { canonical: "Margareten", aliases: ["margareten", "5th district", "district 5"] },
    { canonical: "Wieden", aliases: ["wieden", "4th district", "district 4"] },
    { canonical: "Mariahilf", aliases: ["mariahilf", "6th district", "district 6"] },
    { canonical: "Landstraße", aliases: ["landstrasse", "landstraße", "3rd district", "district 3"] },
  ],
  copenhagen: [
    { canonical: "Indre By", aliases: ["indre by", "city center", "city centre"] },
    { canonical: "Vesterbro", aliases: ["vesterbro"] },
    { canonical: "Nørrebro", aliases: ["norrebro", "nørrebro"] },
    { canonical: "Østerbro", aliases: ["osterbro", "østerbro"] },
    { canonical: "Frederiksberg", aliases: ["frederiksberg"] },
    { canonical: "Christianshavn", aliases: ["christianshavn"] },
  ],
  milan: [
    { canonical: "Brera", aliases: ["brera"] },
    { canonical: "Navigli", aliases: ["navigli"] },
    { canonical: "Porta Romana", aliases: ["porta romana"] },
    { canonical: "Isola", aliases: ["isola"] },
    { canonical: "Porta Venezia", aliases: ["porta venezia"] },
    { canonical: "Duomo", aliases: ["duomo", "centro storico"] },
    { canonical: "NoLo", aliases: ["nolo"] },
  ],
  warsaw: [
    { canonical: "Śródmieście", aliases: ["srodmiescie", "śródmieście", "city center", "city centre"] },
    { canonical: "Praga Północ", aliases: ["praga polnoc", "praga północ"] },
    { canonical: "Praga Południe", aliases: ["praga poludnie", "praga południe"] },
    { canonical: "Mokotów", aliases: ["mokotow", "mokotów"] },
    { canonical: "Wola", aliases: ["wola"] },
    { canonical: "Żoliborz", aliases: ["zoliborz", "żoliborz"] },
  ],
};
